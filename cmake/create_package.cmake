...
set(ENV_VERSION_MINOR "$ENV{INEXOR_MINOR_VERSION}")
if(NOT ENV_VERSION_MINOR)
  set(CPACK_PACKAGE_VERSION_MINOR "9" CACHE STRING "MINOR VERSION NUMBER")
else()
  set(CPACK_PACKAGE_VERSION_MINOR "${ENV_VERSION_MINOR}" CACHE STRING "MINOR VERSION NUMBER")
endif()
...
set(CPACK_PACKAGE_VERSION "${CPACK_PACKAGE_VERSION_MAJOR}.${CPACK_PACKAGE_VERSION_MINOR}-alpha" CACHE STRING "Complete version of the created package.")
